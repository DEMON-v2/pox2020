            ...
            <div class="col-lg-12 mb-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Cloud Information</h6>
                </div>
                <div class="card-body">
                <span class="badge badge-success">Status : Online</span><br><br>
                Cloud Connect : aws://c205e7a8e96b7303610b64ac0ac5bc8c4e57aefb
                </div>
              </div>
