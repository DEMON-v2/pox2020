...
if(preg_match('/database|insert|delete|drop|limit|sleep|0x|hex|like|=|#|;|\r|\n|\t|\(\)|\`|\s/i', $idx)){
  die("Filter!!");
  exit();
}

$view = select_view($idx);
            ...
            <div class="col-lg-12 mb-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">View - Board</h6>
                </div>
                <div class="card-body">
                <a href="/board"><button type="button" class="btn btn-outline-dark btn-sm"> Back </button></a><br><br>
                ...
                <?php while($row = mysqli_fetch_array($view)){?>
                    <tr>
                        <td> <?php echo xss_secure($row['title']); ?> </td>
                        <td> <?php echo xss_secure($row['context']); ?> </td>
                        <td> <?php echo xss_secure($row['author']); ?> </td>
                        <td> <?php echo xss_secure($row['time']); ?> </td>
                    </tr>
                </tbody>
                <?php } ?>
                </table>
