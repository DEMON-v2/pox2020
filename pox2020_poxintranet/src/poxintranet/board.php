          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <a href="/write"><button type="button" class="btn btn-outline-primary btn-sm"> Post Write </button></a><br><br>
                ...
                <tbody>
                    <tr>
                        <td> <strong> [알림] 개인정보 노출에 주의해주시길 바랍니다. </strong> </td>
                        <td> admin </td>
                        <td> 2020-09-31 13:58:49 </td>
                    </tr>
                <?php while($row = mysqli_fetch_array($view)){?>
                    <tr>
                        <td> <a href="read?idx=<?php echo $row['idx'];?>"><?php echo xss_secure($row['title']); ?> </td> </a>
