            ...
            <div class="col-lg-12 mb-6">
              ...
              <div class="card shadow mb-4">
                ...
                <form action="/api/write" method="post">
				        <input type="text" class="form-control form-control-sm" name="title" placeholder="제목을 입력해주세요." required><br>
                <input type="text" class="form-control form-control-sm" name="context" placeholder="내용을 입력해주세요." required><br>
                <button type="submit" class="btn btn-outline-primary btn-sm"> Save </button><br><br>
                </div>
              </div>
